...
const AppleIcon = () => (
  <svg className={styles.socialIcon} viewBox="0 0 24 24" aria-hidden="true">
    <path
      d="M17.05 20.28c-.98.95-2.05 1.78-3.15 1.76-1.09-.02-1.44-.69-2.7-.69-1.25 0-1.65.67-2.67.69-1.03.02-1.99-.71-2.97-1.66-2.02-1.93-3.56-5.46-1.5-9.04 1.02-1.78 2.85-2.91 4.83-2.94 1.5-.02 2.92 1.02 3.83 1.02.9 0 2.65-1.25 4.45-1.06 1.79.08 3.16.81 4.14 2.13-3.08 1.84-2.58 5.48.51 6.74-.83 2.05-1.79 3.1-2.77 4.05zM12.03 7.25c-.02-2.23 1.83-4.04 4.06-4.06.02 2.23-1.83 4.04-4.06 4.06z"
      fill="currentColor"
    />
  </svg>
);
    ...
    <div className={styles.card} ref={cardRef}>
      ...
      <div className={styles.cardHeader}>
        ...
        <p className={styles.subheading}>
          Sign in to book your next cinematic journey.
        </p>
      </div>
